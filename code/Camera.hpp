...
public:
    ...
    static void tick(int player_x) {
        int left_boundary = x + (0.35 * Window::width);
        int right_boundary = x + (0.65 * Window::width);
    ...
    static std::pair<int,int> convert_level_to_screen_coordinates(int level_x, int level_y) {
